...
describe('test del cliente', () => {
  ...
  test('promises - Compra exitosa, pero no puede volver en Taxi', () => {
    return cliente.procesoDeCompra(new Electrodomestico('LCD TV', 4700), 4600).catch((message) => {
  ...
  test('promises - Compra fallida, no me alcanza la plata', () => {
    return cliente.procesoDeCompra(new Electrodomestico('LCD TV', 6000), 5100).catch((message) => {
  ...
  test('promises - Compra fallida, tengo plata pero para mi consideración la LCD TV es muy cara', () => {
    return cliente.procesoDeCompra(new Electrodomestico('LCD TV', 6000), 6100).catch((message) => {
